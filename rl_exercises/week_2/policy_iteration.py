...
class PolicyIteration(AbstractAgent):
    ...
    def __init__(
        ...
        **kwargs: dict,
        ...
        self.pi: np.ndarray = rng.integers(
            0, self.n_actions, self.n_obs
        )  # (5, ) [1, 0, 1, 1, 0] at which state do what?
        self.Q = np.zeros_like(self.R_sa)  # Q.shape = (5, 2)
...
def policy_iteration(
    ...
    while True:
        ...
        # stop until policy converges (no change in policy
